procedure ExecuteProgram2(path:String; parameters:String; okExitCode1:Integer; okExitCode2: Integer; okExitCode3: Integer);
var
    ResultCode: Integer;
begin
 
    Log( 'ExecuteProgram2: path: '+path + ', parameters: '+ parameters + ', okExitCodes: '+ IntToStr(okExitCode1) + ', ' + IntToStr(okExitCode2) + ', ' + IntToStr(okExitCode3));

    if ExecAndLogOutput(path, parameters, '', SW_HIDE,
